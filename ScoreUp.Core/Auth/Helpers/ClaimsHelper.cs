...
namespace ScoreUp.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task AddPermissionClaim(this Microsoft.AspNetCore.Identity.RoleManager<IdentityRole> roleManager, IdentityRole role, string permission)
        {
